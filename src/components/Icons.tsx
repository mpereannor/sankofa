...
export const CloseWishlist = ({ size = 21, color = "#ffffff", ...props }) => (
    <svg
    width={size}
    height={size}
    fill={color}
...
export const Heart = ({ size = 21, strokeWidth = 1, color = "#ffffff", ...props }) => (
<svg
width={size}
height={size}
fill="none"
...
export const HeartFull = ({ size = 21, strokeWidth = 1, color = "#ffffff", ...props }) => (
<svg
width={size}
height={size}
fill={color}
